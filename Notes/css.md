...
--->  Aynı selector içinde de üstten alta kuralı var. background orange sonra green olarak tanımlanırsa green geçerli olur. 
...
CSS dünyasında "cascade'in kırılması" (breaking the cascade), CSS'in en temel çalışma prensibi olan "basamaklılık" (sıralı hiyerarşi) üzerindeki kontrolünüzü kaybetmeniz anlamına gelir.
